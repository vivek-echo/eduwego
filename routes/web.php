...
use App\Http\Controllers\WebPipeLines\ContactController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
/***contatct */
Route::match(['get', 'post'], '/contacts', [ContactController::class,'contactsIndex']);
Route::match(['get', 'post'], '/submitContact', [ContactController::class,'submitContact']);
