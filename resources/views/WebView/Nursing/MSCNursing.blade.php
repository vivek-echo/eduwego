            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="blogarae__img__2 course__details__img__2" data-aos="fade-up">
                        <img loading="lazy" src="{{ asset('assets/img/courses/course-2.jpg') }}" alt="blog">
                    </div>
                            ...
                            <ul class="course__details__populer__list">
                                <li>
                                    ...
                                    <div class="course__details__populer__img">
                                        <img loading="lazy" src="{{ asset('assets/img/courses/course-1.jpg') }}"
                                ...
                                <li>
                                    ...
                                    <div class="course__details__populer__img">
                                        <img loading="lazy" src="{{ asset('assets/img/courses/course-5.jpg') }}"
                                            alt="courses" width="90" height="70">
                                    </div>
                                    <div class="course__details__populer__content">
                                        <h6>
                                ...
                                <li>
                                    ...
                                    <div class="course__details__populer__img">
                                        <img loading="lazy" src="{{ asset('assets/img/courses/course-6.jpg') }}"
                                            alt="courses" width="90" height="70">
                                    </div>
                                    <div class="course__details__populer__content">
                                        <h6>
