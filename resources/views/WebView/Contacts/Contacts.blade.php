                    ...
                    <div class="single__contact d-block">
                        <div class="mapouter">
                            <div class="gmap_canvas w-100" style="height: 560px;">
                                <iframe class="w-100" height="560" id="gmap_canvas"
                                    src="https://maps.google.com/maps?q=82%2F17%2C+Tavarekere+Village%2CTavarekere+Hobli%2C+Bangalore+South+Taluk+%2CNear+Tavarekere-Bus+Stand%2CBangalore%2C+Karnataka+-562130&t=&z=9&ie=UTF8&iwloc=&output=embed"
                                ...
                                <div class="col-xl-12" data-aos="fade-up">
                                    <div class="contact__button">
                                        ...
                                        <button type="submit" value="submit" class="default__button"
                                            name="submit">Submit Query</button>
