            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="single__contact">
                    ...
                    <div class="contact__text">
                        ...
                        <div class="contact__email">
                            <p>82/17, Tavarekere Village,Tavarekere Hobli, Bangalore South Taluk ,Near Tavarekere-Bus Stand,Bangalore, Karnataka -562130</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12" data-aos="fade-up">
                                <div class="contact__button">
                                    ...
                                    <button type="submit" value="submit" class="default__button" name="submit">Submit Query</button>
