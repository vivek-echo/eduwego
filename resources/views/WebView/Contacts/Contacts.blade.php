            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="single__contact">
                    ...
                    <div class="contact__text">
                        ...
                        <div class="contact__email">
                            <p class="mb-4">82/17, Tavarekere Village,Tavarekere Hobli, Bangalore South Taluk ,Near
                                Tavarekere-Bus Stand,Bangalore, Karnataka -562130</p>
                        </div>
                    </div>
                </div>
                <div class="single__contact d-block">
                    <div class="mapouter">
                        <div class="gmap_canvas w-100" style="height: 560px;">
                            <iframe class="w-100" height="560" id="gmap_canvas" src="https://maps.google.com/maps?q=82%2F17%2C+Tavarekere+Village%2CTavarekere+Hobli%2C+Bangalore+South+Taluk+%2CNear+Tavarekere-Bus+Stand%2CBangalore%2C+Karnataka+-562130&t=&z=9&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="contact__form__inner">
                    ...
                    <form id="contactForm" action="/submitContact" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6" data-aos="fade-up">
                                <div class="contact__input__wraper">
                                    <input type="text" name="con_subject" id="con_subject" placeholder="Enter Your Subject">
                                    <div class="contact__icon">
                            ...
                            <div class="col-xl-6" data-aos="fade-up">
                                <div class="contact__input__wraper">
                                    <input type="text" name="con_phone" id="con_phone" placeholder="Enter Your Phone">
                                    <div class="contact__icon">
                            ...
                            <div class="col-xl-12" data-aos="fade-up">
                                <div class="contact__button">
                                    ...
                                    <button type="submit" class="default__button">Submit Query</button>
...
<script>
    $(document).ready(function() {
        $('#contactForm').on('submit', function(e) {
            ...
            const con_name = $('#con_name').val();
            const con_email = $('#con_email').val();
            const con_subject = $('#con_subject').val();
            const con_phone = $('#con_phone').val();
            const con_message = $('#con_message').val();
            ...
            if (con_email != "") {
                ...
                var isValid = emailRegex.test(con_email)
                console.log("dsjc djsb hjgsd dg bg", isValid);
                if (isValid === false) {
                    Swal.fire({
                        icon: "warning",
                        title: "REQUIRED",
            ...
            if (con_phone != "") {
                ...
                var isValid = phoneRegex.test(con_phone)
                if (isValid === false) {
                    Swal.fire({
                        icon: "warning",
                        title: "REQUIRED",
            ...
            swalWithBootstrapButtons.fire({
                title: "We Will be happy t0 intract with you",
