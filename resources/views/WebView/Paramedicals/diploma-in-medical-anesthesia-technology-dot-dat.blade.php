                ...
                <div class="col-xl-12">
                    <div class="breadcrumb__content__wraper" data-aos="fade-up">
                        <div class="breadcrumb__title">
                            <h2 class="heading text-white">Diploma in Medical Anesthesia Technology (DOT/DAT)</h2>
                        </div>
                        <div class="breadcrumb__inner">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li>Diploma in Medical Anesthesia Technology (DOT/DAT)</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="blogarae__img__2 course__details__img__2" data-aos="fade-up">
                        <img loading="lazy" src="{{ asset('assets/img/courses/course-8.jpg') }}" alt="blog">
                    </div>
                                ...
                                <div class="course__details__wraper" data-aos="fade-up">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="lh-1-5 mb-0">Indian Nursing Council ( INC ), Karnataka Nursing Council
                                                ( KNC )</p>
                                        </div>
                                    </div>
                    ...
                    <div class="course__details__sidebar">
                        ...
                        <div class="blogsidebar__content__wraper__2" data-aos="fade-up">
                            ...
                            <ul class="course__details__populer__list">
                                <li>
                                    ...
                                    <div class="course__details__populer__content">
                                        <h6>
                                            <a href="/diploma-in-medical-laboratory-technology-dmlt">DMLT</a>
                                        </h6>
                                    </div>
                                </li>
                                <li>
                            ...
                            <div class="course__summery__button">
                                ...
                                <a class="default__button default__button--3" href="tel:+91 9916073632"><i
                                        class="icofont-phone"></i> +91 9916073632</a>
                            </div>
